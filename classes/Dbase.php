...
class Dbase {
	...
	private function connect() {
		...
		if(!$this->_conndb) {
			...
			die("database connction failed:<br />".mysql_error());
	...
	public function displayQuery($result) {
		...
		if(!$result) {
			...
			$output = "Database query failed:<br /> ".mysql_error()."<br />";
			$output .= "last SQL query was:<br />".$this->_last_query;
			die($output);
